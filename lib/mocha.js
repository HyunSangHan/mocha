 ...
 * @param {boolean} [options.allowUnhandled] - Propagate unhandled rejections?
 ...
 * @param {boolean} [allowUnhandled=true] - Whether to propagate unhandled rejections.
 * @return {Mocha} this
 * @chainable
 */
...
Mocha.prototype.allowUnhandled = function(allowUnhandled) {
  this.options.allowUnhandled = allowUnhandled !== false;
  return this;
};
...
Mocha.prototype.run = function(fn) {
  ...
  runner.allowUnhandled = options.allowUnhandled;
